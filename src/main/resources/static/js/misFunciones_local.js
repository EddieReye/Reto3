...
function editarRegistroCategory (idCategory){
	$.ajax({    
    url : 'http://localhost/api/Category/'+idCategory,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function eliminarRegistroCategory(idCategory){
	$.ajax(    
    'http://localhost/api/Category/'+idCategory,
	{type : 'DELETE',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function editarRegistroClient(idClient){
    ...
    $.ajax({    
    url : 'http://localhost/api/Client/'+idClient,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function eliminarRegistroClient(idClient){
	$.ajax(    
    'http://localhost/api/Client/'+idClient,
	{type : 'DELETE',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function editarRegistroMessage (idMess){
    ...
    $.ajax({    
    url : 'http://localhost/api/Message/'+idMess,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function eliminarRegistroMessage(idMessage){
	$.ajax(    
    'http://localhost/api/Message/'+idMessage,
	{type : 'DELETE',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function eliminarRegistroReservation(idReservation){
	$.ajax(    
    'http://localhost/api/Reservation/'+idReservation,
	{type : 'DELETE',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
